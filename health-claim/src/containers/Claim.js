...
export default class Claim extends Component {
  ...
  render() {
    const healthRecord1 = { title: "Health record 1", description: "Issued by doctor Smith" }
    const healthRecord2 = { title: "Health record 2", description: "Issued by doctor Ben" }
    const healthRecord3 = { title: "Health record 3", description: "Issued by doctor Michael" }
